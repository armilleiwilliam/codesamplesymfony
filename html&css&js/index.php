...
<article class="col-sm-6 col-ie-7">
  ...
  <!-- start biography -->
  <div class="col-sm-12"><img src="images/dobermann_home1.jpg" class="img-responsive thumbnail" style="float:left;width:40%;margin-right:15px;" />
    <p>L&rsquo;allevamento &ldquo;Di Casa Fox Dobermann&rdquo; nasce dalla passione di Stefano Sardelli per questa meravigliosa razza, passione che comincia con l&rsquo;acquisto, nel 1993, quando era ancora un ragazzo, del suo primo Dobermann in un allevamento in Toscana.</p>
    Negli anni successivi, grazie al lavoro svolto con professionalit&agrave;, l&rsquo;allevamento ottiene il riconoscimento ENCI ed FCI con l&rsquo;affisso &ldquo;DI CASA FOX&rsquo;. <br/>
    <br/>
  </div>
  <!-- close giogrphy -->
...
<article class="col-sm-6 col-ie-7">
  <h3>Oltre alla vendita di cuccioli offriamo anche i seguenti servizi:</h3>
  <ul>
    <li>Imprinting e socializzazione del cucciolo</li>
    <li>Educazione di base</li>
    <li>Riabilitazione cani problematici</li>
    <li>Obbedienza</li>
    <li>Preparazione di cani da utilit&agrave; e difesa
  ...
  <h3>Conttataci per ricevere maggiori informazioni sui nostri servizi:</h3>
  <br />
...
<article class="col-sm-6 text-left col-ie-7">
  <div style="max-width:487px;margin:0 auto;">
    ...
    <div id="show" class="slideshow">
      <div class="slideshow-images"> <a href=""><img id="slide-0" src="data/images/1.jpg" alt="1" title="1" /></a> <a href=""><img id="slide-1" src="data/images/4.jpg" alt="4" title="4" /></a> <a href=""><img id="slide-2" src="data/images/3.jpg" alt="3" title="3" /></a> <a href=""><img id="slide-3" src="data/images/2.jpg" alt="2" title="2" /></a> </div>
      <a id="vlb" href="http://visualslideshow.com">Picture Slideshow by VisualSlideshow.com v1.6m</a> </div>
...
<article class="col-sm-12 bottom-home">
  ...
  <div class="col-sm-4 text-center col-ie-7-4">
    <h3>Maschi</h3>
    <a href="campioni_maschi_femmine.php" target="_blank"><img src="image/maschi.jpg" class="img-responsive" style="margin:0 auto;"/></a> </div>
  <div class="col-sm-4 text-center col-ie-7-4">
    <h3>Femmine</h3>
    <a href="campioni_maschi_femmine.php" target="_blank"><img src="image/femmine.jpg" class="img-responsive" style="margin:0 auto;"/></a> </div>
  <div class="col-sm-4 text-center col-ie-7-4">
    <h3>Cuccioli</h3>
